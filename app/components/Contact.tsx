    ...
    <>
      <section id="contact" ref={sectionRef} className="py-28 px-6">
        <div className="max-w-[700px] mx-auto">
          ...
          <div className="reveal glass-card p-12 text-center">
            <div className="section-label inline-flex mb-6">
              <span>◈</span> Contact
            </div>
            <h2 className="font-heading font-extrabold text-4xl sm:text-5xl text-white mb-5 leading-tight">
              Get in <span className="gradient-text">Touch</span>
            </h2>
            <p className="text-[#9a8fb8] text-base leading-relaxed mb-10 max-w-[500px] mx-auto">
      ...
      {/* Footer */}
      <footer className="border-t border-[rgba(13,148,136,0.08)] py-8 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <span className="text-[#7a6f96] text-sm">
